            ...
            </Helmet>
            {
                ...
                <Helmet>
                    <link
                        type="text/css"
                        rel="stylesheet"
                        href="/Fonts/Persian/fontiran.css"
                    />
                    <link
                        type="text/css"
                        rel="stylesheet"
                        href="/Fonts/Persian/style.css"
                    />
                </Helmet>
            }
            {
            ...
            >
                {
                    <Transition
                        ...
                        enterFrom={`-ml-72 lg:-ml-[20%] 2xl:-ml-[16.6666%]`}
                        enterTo="ml-0"
                        leave="transition-all duration-300"
                        leaveFrom="ml-0"
                        leaveTo={`-ml-72 lg:-ml-[20%] 2xl:-ml-[16.6666%]`}
                        className={
                    ...
                    >
                        {
                            ...
                            <Skeleton
                                variant='rectangular'
                                className="skeleton z-20 absolute top-0 right-0 bottom-0 left-0 h-auto bg-gray-200"
                                animation="wave"
                            />
                        }
                        <TopContext.Provider
